...
import {GlobalState, StateNotes} from "./typeConfig.ts";
...
class App extends React.Component<Props> {
    ...
    render() {
        //console.log("App notes", this.props.notes)
        ...
        return (
            ...
            <div className="d-flex flex-column gap-2">
                ...
                <List notes={this.state.notes.length === 0 ? this.props.notes : this.state.notes} onEdit={(id: string) => this.changeMode("edit", id,null)}/>
            </div>
        )
    }
}
